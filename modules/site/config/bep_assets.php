...
$config['asset'][] = array('file'=>'fullcalendar.css');
$config['asset'][] = array('file'=>'calendrical.css');
$config['asset'][] = array('file'=>'ui-lightness/jquery-ui-1.8.13.custom.css','name'=>'ui_lightness_css');
$config['asset'][] = array('file'=>'fullcalendar.print.css');
$config['asset'][] = array('file'=>'jquery.timepickr.css');
...
// BackendPro JS
//$config['asset'][] = array('file'=>'http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js', 'name'=>'jquery');
$config['asset'][] = array('file'=>'jquery-1.6.1.min.js', 'name'=>'jquery', 'position'=>'header' );
