        ...
        <ol>
            <li>
                ...
                <ul>
                    ...
                    <li><?php print form_radio('domain','exclude',$this->validation->set_radio('domain','exclude'),'id="domain"')?>Exclude domains <span class="annotation">( multiple domain, separated by comma )</span>
                        <ul>
                            <li><textarea name="url_exclude" id="url_exclude" style="width:300px;height:100px;"><?=$this->validation->url_exclude?></textarea></li>
                        </ul>
                    </li>
                    ...
                    <li><?php print form_radio('domain','specific',$this->validation->set_radio('domain','specific'),'id="domain"')?>Specific domains <span class="annotation">( multiple domain, separated by comma )</span><br />
                        <ul>
                            <li><textarea name="url_include" id="url_include" style="width:300px;height:100px;"><?=$this->validation->url_include?></textarea></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li><?php print form_radio('browser','all',$this->validation->set_radio('browser','all'),'id="browser"')?>Exclude browser <span class="annotation">( multiple browser, separated by comma )</span>
                        <ul>
                            <li><textarea name="browser_exclude" id="browser_exclude" style="width:300px;height:100px;"><?=$this->validation->browser_exclude?></textarea></li>
                        </ul>
                    </li>
                    <li><?php print form_radio('browser','specific',$this->validation->set_radio('browser','specific'),'id="browser"')?>Specific browsers <span class="annotation">( multiple browser, separated by comma )
                        <ul>
                            <li><textarea name="browser_include" id="browser_include" style="width:300px;height:100px;"><?=$this->validation->browser_include?></textarea></li>
                        </ul>
                    </li>
                </ul>
            </li>
