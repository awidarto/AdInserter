...
<div class="buttons">                
	<a href="<?php print  site_url('ad/admin/domains/formpos')?>">
    <?php print  $this->bep_assets->icon('add');?>
    Add Insert Position
    </a>
</div><br/><br/>

<?php print form_open('ad/admin/domains/delpos')?>
<table class="data_grid" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="middle"><a href="<?php print site_url('ad/admin/domains/formpos/'.$row['id'])?>"><?php print $this->bep_assets->icon('pencil');?></a></td>
