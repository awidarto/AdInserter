...
class Auth_form_processing
{
	...
	function _register()
	{
		...
		$data['user_profiles']['fullname'] = $this->CI->input->post('email');
		$data['user_profiles']['company'] = $this->CI->input->post('company');
		$data['user_profiles']['address'] = $this->CI->input->post('address');
		...
		$data['user_profiles']['phone'] = $this->CI->input->post('phone');
		$data['user_profiles']['mobile'] = $this->CI->input->post('mobile');
		$data['user_profiles']['fax'] = $this->CI->input->post('fax');
